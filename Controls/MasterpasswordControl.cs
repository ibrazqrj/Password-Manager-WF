...
namespace Password_Manager_WF.Controls
{
    ...
    public partial class MasterpasswordControl : UserControl
    {
        ...
        private void MpChangedOnClick(object sender, EventArgs e)
        {
            ...
            string confirmPassword = tbNewPasswordConfirm.Text;

            if (newPassword != confirmPassword)
            {
                toastWindowsNotification.ShowNotification("7f6a8153-3d9e-4d74-be66-2f13b6d196f0");
                return;
            }
            ...
            if (success)
            {
                toastWindowsNotification.ShowNotification("4a211faf-9d32-4cce-bcaf-4c8ade2cd07c");
                Application.Restart();
            ...
            {
                toastWindowsNotification.ShowNotification("345efb63-9e01-443c-b0cf-755278c4832d");
            }
            else
            {
                toastWindowsNotification.ShowNotification("f419951b-a23d-4e9b-a3ca-cc0f32486652");
            }
        }
    }
}
